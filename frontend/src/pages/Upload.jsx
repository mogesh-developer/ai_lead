        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-800/80 border border-slate-700 rounded-2xl shadow-2xl p-8">
            ...
            {activeTab === 'manual' && (
              <form onSubmit={handleManualSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-bold text-slate-200 mb-3">Website</label>
                    <input
                      type="text"
                      name="website"
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-bold text-slate-200 mb-3">Notes</label>
                    <textarea
                      name="notes"
            ...
            <div className={`mt-8 p-4 rounded-xl border font-medium ${
              (message.includes('failed') || message.includes('required') || message.includes('Invalid'))
